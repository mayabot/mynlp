...
//            List<String> lablist = Guava.split(firstLine,",");
//
//
...
//                List<String> paramArray = Guava.split(line,",");
...
//
//        // 需要统计一下每个标签出现的次数
//        HashMap<String, Long> _total = new HashMap();
...
//        // 初始概率
//        HashMap<String, Double> _start_probability =  new HashMap();
