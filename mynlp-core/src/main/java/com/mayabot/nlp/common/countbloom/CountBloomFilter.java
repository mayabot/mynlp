...
public final class CountBloomFilter<T> implements Serializable {
	...
	public double expectedFpp() {
		...
		return Math.pow((double) count / bits.length, numHashFunctions);
	}
	...
	public void removeCount(T object) {
		strategy.removeCount(object, funnel, numHashFunctions, bits);
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(bf.mayCount("x"));
	}
	...
	interface Strategy extends Serializable {
		...
		<T> int removeCount(T object, Funnel<? super T> funnel,
						 int numHashFunctions, short[] bits);
