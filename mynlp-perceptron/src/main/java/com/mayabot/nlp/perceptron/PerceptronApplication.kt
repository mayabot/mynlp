...
fun main() {
    val cws = CwsPerceptronDefinition()
    cws.train(File("data.work/cws/pku/199801.txt"),
            File("data.work/cws/pku/199802.txt"),
            20, 1, false)
}
