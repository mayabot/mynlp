 ...
 * @author jimichan
 */
public class OptimizeWordPathProcessor extends BaseSegmentComponent implements WordpathProcessor {
    ...
    public String toString() {
        return getOptimizeProcessorList().stream().map(it -> it.getClass().getSimpleName()).collect(Collectors.toList()).toString();
    }
}
