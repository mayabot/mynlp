...
import com.mayabot.nlp.segment.hmmner.org.nt.NTDictionary;
import com.mayabot.nlp.segment.hmmner.org.nt.OrganizationDictionary;
 ...
 * @author jimichan
 */
public class OrganizationRecognition extends BaseSegmentComponent implements OptimizeProcessor {
...
//    final NatureAttribute natureAttribute;
    ...
    public OrganizationRecognition(OrganizationDictionary placeDictionary) {
        ...
        defaultEnumFreqPair = new EnumFreqPair(NTTag.Z, a_total_freq);
...
//            } else
    ...
    private boolean isBadCase2(String name) {
        ...
        return nrEnumFreqPair.containsLabel(NTTag.Z);
    }
