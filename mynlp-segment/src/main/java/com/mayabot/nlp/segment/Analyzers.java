...
//     */
//    public static MynlpAnalyzer standard(Lexer tokenizer) {
...
//        return standard(Tokenizers.core());
//    }
//
//
//    /**
...
//     * @return MynlpAnalyzer
//     */
//    public static MynlpAnalyzer from(Lexer tokenizer) {
//        return new DefaultMynlpAnalyzer(tokenizer).
...
//     * @return MynlpAnalyzer
//     */
//    public static MynlpAnalyzer noPunctuation(Lexer tokenizer) {
//        return new DefaultMynlpAnalyzer(tokenizer).
//                setFillStopWord(false).
//                setFilterPunctuaction(true);
//    }
